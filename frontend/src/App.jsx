...
import DoctorAppointment from "./components/Profile/doctor/DoctorAppointment";
        ...
        <ThemeProvider theme={theme}>
          ...
          <Router>
            <Routes>
              ...
              {/* Nurse Routes */}
              <Route element={<PrivateRoute allowedRoles={["nurse", "admin"]} />}>
              ...
              {/* Patient Routes */}
              <Route element={<PrivateRoute allowedRoles={["patient", "admin"]} />}>

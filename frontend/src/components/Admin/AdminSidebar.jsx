...
const AdminSidebar = ({ userName }) => {
  ...
  const menuItems = [
    ...
    { text: "Doctor", icon: <MedicalIcon />, path: "/admin-doctor" },
    { text: "Nurse", icon: <PeopleIcon />, path: "/admin-nurse" },
    { text: "Patient", icon: <PeopleIcon />, path: "/admin-patient" },
    { text: "Department", icon: <HospitalIcon />, path: "/admin-department" },
    { text: "Query", icon: <QueryIcon />, path: "/admin-query" },
  ...
  return (
    ...
    >
      <Box sx={{ p: 4, display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 2 }}>
        <Avatar
          src={getUserAvatar({ name: userName, email: 'admin@hms.com' })}
